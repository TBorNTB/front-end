...
import { ChevronDown, ArrowRight, BookOpen, Code, Shield } from 'lucide-react';

export default function HeroBanner() {
  return (
    <section className="relative flex flex-col items-center justify-center px-6 text-center bg-black" style={{ height: '450px' }}>
      ...
      <div className="relative z-10">
        ...
        <div className="inline-flex bg-black/50 backdrop-blur-sm rounded-full px-3 py-1.5 mt-10 mb-4 border border-primary-500">
        ...
        <h2 className="mb-3 flex justify-center items-center text-3xl text-white font-extrabold md:text-5xl">
          Welcome to <img src={"/logo-white.svg"} width={120} height={60} className="px-3" /> HUB
        </h2>
        ...
        <div className="flex flex-col items-center animate-bounce mt-15">
          <span className="mb-2 text-xs font-medium text-secondary-300 drop-shadow-[0_0_6px_rgba(58,77,161,0.6)]">
            Explore More
          </span>
          <ChevronDown 
            size={24} 
            className="animate-pulse text-primary-500 drop-shadow-[0_0_12px_rgba(58,77,161,0.8)]"
          />
        </div>
      </div>
