...
import { Megaphone, Calendar, User, Pin, Users } from "lucide-react";
import NewsContent from "./_components/NewsContent";

type Tab = "announcements" | "posts";
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-10">
        ...
        <section className="mb-6 flex justify-center">
          <div className="w-full max-w-2xl flex rounded-xl bg-white border border-gray-200 p-1 shadow-sm">
            <TabButton
              icon={Megaphone}
              label="운영진 공지"
