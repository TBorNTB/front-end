          ...
          <div>
            <div className="border-b border-gray-200 pb-4 mb-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">커뮤니티 뱃지를 생성하고 관리합니다</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">첫 프로젝트를 등록한 회원에게 부여</p>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">커뮤니티에 활발히 참여하는 회원</p>
                <div className="flex justify-center space-x-2">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">후배들을 잘 도와준 선배 회원</p>
                <div className="flex justify-center space-x-2">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-400 hover:bg-primary-50 transition-colors cursor-pointer">
                ...
                <h4 className="font-medium text-gray-600 mb-2">새 뱃지 추가</h4>
                <p className="text-sm text-gray-500">커뮤니티 뱃지를 만들어보세요</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === "assignment" && (
          <div>
            <div className="border-b border-gray-200 pb-4 mb-6">
              ...
              <p className="text-sm text-gray-600 mt-1">회원들에게 뱃지를 수동으로 부여합니다</p>
            </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">김철수에게 첫 번째 프로젝트 뱃지 부여</span>
                    <span className="text-gray-400">10분 전</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">이영희에게 활발한 참여자 뱃지 부여</span>
