...
import { Check, User, Lock, Github,Shield, X, Eye, EyeOff } from "lucide-react";
      ...
      <div className="flex h-screen w-full items-center justify-center bg-background">
        ...
        <div className="flex h-[550px] w-[850px] rounded-xl bg-white shadow-xl shadow-primary-500/10 overflow-hidden z-10 border border-gray-200">
          ...
          <div className="flex flex-col items-center justify-center w-1/3 bg-gradient-to-br from-primary-500 to-primary-700 p-10 text-center">
            ...
            {/* Admin Access Link in Left Panel */}
            <div className="mt-4 pt-4 border-t border-primary-400/30 w-full">
              <p className="text-primary-200 text-xs mb-2">관리자이신가요?</p>
              <Link
                href="/admin/login"
                className="inline-flex items-center gap-2 px-3 py-2 text-xs font-medium text-primary-100 bg-primary-800/50 hover:bg-primary-800 border-[1.5px] border-primary-600/50 hover:border-primary-600 rounded-md transition-all duration-200"
              >
                <Shield size={16} />
                관리자 로그인
              </Link>
